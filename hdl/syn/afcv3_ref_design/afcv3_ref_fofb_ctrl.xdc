...
create_clock -period $fmc0_fs_clk_period                      [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLK} -of_objects \
...
create_clock -period $afc_fp2_clk1_period                     [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLK} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_2*GT_IF/gtp7_if_gen[0]*gtpe2_i*}]]
create_clock -period $afc_fp2_clk1_period                     [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLK} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_2*GT_IF/gtp7_if_gen[1]*gtpe2_i*}]]
create_clock -period $afc_fp2_clk1_period                     [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLK} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_2*GT_IF/gtp7_if_gen[2]*gtpe2_i*}]]
create_clock -period $afc_fp2_clk1_period                     [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLK} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_2*GT_IF/gtp7_if_gen[3]*gtpe2_i*}]]

set gt_txoutclk_pins                                          [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLK} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *GT_IF*gtpe2_i*}]]
set gt_txoutclk_clocks                                        [get_clocks -of_objects $gt_txoutclk_pins]

#################################
# TXOUTCLKFABRIC
#################################

create_clock -period $fmc0_fs_clk_period                      [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLKFABRIC} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_0*GT_IF/gtp7_if_gen[0]*gtpe2_i*}]]
create_clock -period $fmc0_fs_clk_period                      [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLKFABRIC} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_0*GT_IF/gtp7_if_gen[1]*gtpe2_i*}]]
create_clock -period $fmc0_fs_clk_period                      [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLKFABRIC} -of_objects \
...
set gt_txoutclkfabric_pins                                    [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLKFABRIC} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *GT_IF*gtpe2_i*}]]
set gt_txoutclkfabric_clocks                                  [get_clocks -of_objects $gt_txoutclkfabric_pins]

#################################
# RXOUTCLK
#################################

create_clock -period $fmc0_fs_clk_period                      [get_pins -filter {REF_PIN_NAME =~ *RXOUTCLK} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_0*GT_IF/gtp7_if_gen[0]*gtpe2_i*}]]
create_clock -period $fmc0_fs_clk_period                      [get_pins -filter {REF_PIN_NAME =~ *RXOUTCLK} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_0*GT_IF/gtp7_if_gen[1]*gtpe2_i*}]]
create_clock -period $fmc0_fs_clk_period                      [get_pins -filter {REF_PIN_NAME =~ *RXOUTCLK} -of_objects \
...
set gt_rxoutclkfabric_pins                                    [get_pins -filter {REF_PIN_NAME =~ *RXOUTCLK} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *GT_IF*gtpe2_i*}]]
set gt_rxoutclkfabric_clocks                                  [get_clocks -of_objects $gt_rxoutclkfabric_pins]
...
set_max_delay -datapath_only -from               [get_clocks clk_sys] -to [get_clocks $gt_txoutclk_clocks]    $afc_fp2_clk1_period
...
set_max_delay -datapath_only -from               [get_clocks $gt_txoutclk_clocks]    -to [get_clocks clk_sys] $clk_sys_period
...
set_max_delay -datapath_only -from               [get_clocks clk_aux] -to [get_clocks $gt_txoutclk_clocks]    $afc_fp2_clk1_period
...
set_max_delay -datapath_only -from               [get_clocks $gt_txoutclk_clocks] -to [get_clocks clk_aux]    $clk_aux_period
...
set_max_delay -datapath_only -from               [get_clocks clk_pll_i] -to [get_clocks $gt_txoutclk_clocks]    $afc_fp2_clk1_period

# CDC between clk_pll_i (DDR core clock) and DCC GT
set_max_delay -datapath_only -from               [get_clocks $gt_txoutclk_clocks] -to [get_clocks clk_pll_i]    $clk_pll_ddr_period
