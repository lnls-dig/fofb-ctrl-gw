...
set gt_fmc_txoutclk_pins                                          [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLK} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_0*GT_IF*gtpe2_i*}]]
set gt_fmc_txoutclk_clocks                                        [get_clocks -of_objects $gt_fmc_txoutclk_pins]
...
set gt_fmc_txoutclkfabric_pins                                    [get_pins -filter {REF_PIN_NAME =~ *TXOUTCLKFABRIC} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_0*GT_IF*gtpe2_i*}]]
set gt_fmc_txoutclkfabric_clocks                                  [get_clocks -of_objects $gt_fmc_txoutclkfabric_pins]
...
set gt_fmc_rxoutclkfabric_pins                                    [get_pins -filter {REF_PIN_NAME =~ *RXOUTCLK} -of_objects \
                                                                [get_cells -hier -filter {NAME =~ *cmp_fofb_ctrl_wrapper_0*GT_IF*gtpe2_i*}]]
set gt_fmc_rxoutclkfabric_clocks                                  [get_clocks -of_objects $gt_fmc_rxoutclkfabric_pins]
...
set_max_delay -datapath_only -from               [get_clocks clk_sys] -to [get_clocks $gt_fmc_txoutclk_clocks]    $fmc0_fs_clk_period
set_max_delay -datapath_only -from               [get_clocks $gt_fmc_txoutclk_clocks]    -to [get_clocks clk_sys] $clk_sys_period
...
set_max_delay -datapath_only -from               [get_clocks clk_aux] -to [get_clocks $gt_fmc_txoutclk_clocks]    $fmc0_fs_clk_period
set_max_delay -datapath_only -from               [get_clocks $gt_fmc_txoutclk_clocks] -to [get_clocks clk_aux]    $clk_aux_period
