...
entity wb_fofb_shaper_filt_regs is
  port (
    ...
    ch_0_coeffs_addr_o   : out   std_logic_vector(8 downto 2);
    ...
    ch_1_coeffs_addr_o   : out   std_logic_vector(8 downto 2);
    ...
    ch_2_coeffs_addr_o   : out   std_logic_vector(8 downto 2);
    ...
    ch_3_coeffs_addr_o   : out   std_logic_vector(8 downto 2);
    ...
    ch_4_coeffs_addr_o   : out   std_logic_vector(8 downto 2);
    ...
    ch_5_coeffs_addr_o   : out   std_logic_vector(8 downto 2);
    ...
    ch_6_coeffs_addr_o   : out   std_logic_vector(8 downto 2);
    ...
    ch_7_coeffs_addr_o   : out   std_logic_vector(8 downto 2);
    ...
    ch_8_coeffs_addr_o   : out   std_logic_vector(8 downto 2);
    ...
    ch_9_coeffs_addr_o   : out   std_logic_vector(8 downto 2);
    ...
    ch_10_coeffs_addr_o  : out   std_logic_vector(8 downto 2);
    ...
    ch_11_coeffs_addr_o  : out   std_logic_vector(8 downto 2);
...
begin
  ...
  process (adr_int, wr_adr_d0, ch_0_coeffs_re) begin
    if ch_0_coeffs_re = '1' then
      ch_0_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_0_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_1_coeffs_re) begin
    if ch_1_coeffs_re = '1' then
      ch_1_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_1_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_2_coeffs_re) begin
    if ch_2_coeffs_re = '1' then
      ch_2_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_2_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_3_coeffs_re) begin
    if ch_3_coeffs_re = '1' then
      ch_3_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_3_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_4_coeffs_re) begin
    if ch_4_coeffs_re = '1' then
      ch_4_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_4_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_5_coeffs_re) begin
    if ch_5_coeffs_re = '1' then
      ch_5_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_5_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_6_coeffs_re) begin
    if ch_6_coeffs_re = '1' then
      ch_6_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_6_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_7_coeffs_re) begin
    if ch_7_coeffs_re = '1' then
      ch_7_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_7_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_8_coeffs_re) begin
    if ch_8_coeffs_re = '1' then
      ch_8_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_8_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_9_coeffs_re) begin
    if ch_9_coeffs_re = '1' then
      ch_9_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_9_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_10_coeffs_re) begin
    if ch_10_coeffs_re = '1' then
      ch_10_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_10_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
  ...
  process (adr_int, wr_adr_d0, ch_11_coeffs_re) begin
    if ch_11_coeffs_re = '1' then
      ch_11_coeffs_addr_o <= adr_int(8 downto 2);
    else
      ch_11_coeffs_addr_o <= wr_adr_d0(8 downto 2);
    end if;
  end process;
